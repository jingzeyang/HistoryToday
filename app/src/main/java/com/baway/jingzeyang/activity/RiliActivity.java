...
import com.baway.jingzeyang.utils.KCalendar;
...
public class RiliActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        popupwindow_calendar_bt_enter
                .setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        Intent it = new Intent(RiliActivity.this, MyApp.context.getClass());
                        it.putExtra("mes", date);
                        startActivity(it);
                        finish();
                    }
                });
